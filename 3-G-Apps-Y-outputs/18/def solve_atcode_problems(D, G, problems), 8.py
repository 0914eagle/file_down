...
def solve_atcode_problems(D, G, problems):
    ...
    for i in range(2 ** D):
        ...
        if total_score >= G:
            ...
            num_additional_problems = min(problems[max_problem][0], -(-(G - total_score) // (100 * (max_problem + 1))))
...
result = solve_atcode_problems(D, G, problems)
print(result)
