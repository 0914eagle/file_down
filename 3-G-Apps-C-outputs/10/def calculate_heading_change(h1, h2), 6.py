...
def calculate_heading_change(h1, h2):
    return abs(h1 - h2) % 360000

def transportation_switching_scheme(t, n, transportation_types, points):
    dp = [float('inf')] * n
    dp[0] = 0
...
print(transportation_switching_scheme(t, n, transportation_types, points))
